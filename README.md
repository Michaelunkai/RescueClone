...
RescueClone is a clean-room Windows backup/recovery suite foundation. The current verified slice supports directory image creation, verification, restore, JSON-defined directory backup job runs, and read-only restore planning through the GUI, CLI, and PowerShell module.
