...
public static class FeatureCatalog
{
    public static IReadOnlyList<FeatureSurface> All { get; } = new List<FeatureSurface>
    {
        ...
        new("image.protect.audit", "Verify Image", "rc image protect-audit", "Test-RCImageRepositoryProtection", true),
        new("image.protect.apply", "Verify Image", "rc image protect", "Set-RCImageRepositoryProtection", true),
        ...
        new("clone.directory", "Clone", "rc clone directory", "Copy-RCDirectoryClone", true),
        ...
        new("rescue.answer.execute", "Rescue", "rc rescue answer-execute", "Start-RCRescueAnswer", true),
