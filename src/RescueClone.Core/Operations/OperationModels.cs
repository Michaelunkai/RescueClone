...
public static class OperationKindCatalog
{
    public static IReadOnlyList<OperationKindSurface> All { get; } = new List<OperationKindSurface>
    {
        ...
        new("job.backup.directory.create", "Create a directory backup job JSON file.", new[] { "file", "jobId", "name", "source", "image" }, new[] { "enabled", "compression", "password", "verifyAfterCreate", "logDirectory", "advancedJsonFile" }),
        new("job.backup.directory.update", "Update a directory backup job JSON file.", new[] { "file" }, new[] { "jobId", "name", "enabled", "source", "image", "compression", "password", "verifyAfterCreate", "logDirectory", "advancedJsonFile" }),
        ...
        new("rescue.answer.create", "Create an unattended rescue answer file.", new[] { "output", "repository", "image", "targetDiskId" }, new[] { "password", "bootMode", "targetDiskSizeBytes", "requiredBytes", "targetIsCurrentSystemDisk", "hasEfiSystemPartition", "bcdStore", "driverDirectories", "networkShares", "repairBoot", "rebootAfterRestore", "verifyImage", "directoryRestoreTarget" }),
        new("rescue.answer.validate", "Validate an unattended rescue answer file.", new[] { "file" }, new[] { "verifyImage" }),
        new("rescue.answer.execute", "Execute an unattended rescue answer directory restore.", new[] { "file" }, new[] { "verifyImage", "overwrite" }),
