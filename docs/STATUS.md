...
- Job runs can execute configured pre-backup and post-backup script hooks non-interactively, fail the job on nonzero hook exit, and include hook exit/output records in the structured JSON run log.
