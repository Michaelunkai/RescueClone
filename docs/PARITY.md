...
| Repository protection audit | Verify Image tab | `rc image protect-audit` | `Test-RCImageRepositoryProtection` |
| Repository protection apply | Verify Image tab | `rc image protect` | `Set-RCImageRepositoryProtection` |
...
| Verified directory clone | Clone tab | `rc clone directory` | `Copy-RCDirectoryClone` |
...
| Directory backup job history | Backup Job tab | `rc job history` | `Get-RCBackupJobHistory` |
...
| Unattended rescue answer directory execute | Rescue tab | `rc rescue answer-execute` | `Start-RCRescueAnswer` |
| Operation kind listing | Operations tab | `rc operation kinds` | `Get-RCOperationKind` |
| Operation request validation | Operations tab | `rc operation validate` | `Test-RCOperation` |
